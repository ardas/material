 ...
 * v0.8.3.1
 */
function(){"use strict";function e(e,t,n,r,o,a,i,c,d){function l(l,u,f,p){function h(t){h.value=!!t,h.queued||(t?(h.queued=!0,e(function(){l.visible=h.value,h.queued=!1},l.delay)):e(function(){l.visible=!1}))}function g(){E.attr("aria-describedby",u.attr("id")),w.append(u),v(),c.addClass(u,"md-show"),c.addClass($,"md-show"),c.addClass(M,"md-show")}function b(){E.removeAttr("aria-describedby"),d.all([c.removeClass(M,"md-show"),c.removeClass($,"md-show"),c.removeClass(u,"md-show")]).then(function(){l.visible||u.detach()})}function v(){function e(){var e="left"===A||"right"===A?2*Math.sqrt(Math.pow(r.width,2)+Math.pow(r.height/2,2)):2*Math.sqrt(Math.pow(r.width/2,2)+Math.pow(r.height,2)),t="left"===A?{left:100,top:50}:"right"===A?{left:0,top:50}:"top"===A?{left:50,top:100}:{left:50,top:0};$.css({width:e+"px",height:e+"px",left:t.left+"%",top:t.top+"%"})}function t(e){var t={left:e.left,top:e.top};return t.left=Math.min(t.left,w.prop("scrollWidth")-r.width-m),t.left=Math.max(t.left,m),t.top=Math.min(t.top,w.prop("scrollHeight")-r.height-m),t.top=Math.max(t.top,m),t}function n(e){return"left"===e?{left:a.left-r.width-m,top:a.top+a.height/2-r.height/2}:"right"===e?{left:a.left+a.width+m,top:a.top+a.height/2-r.height/2}:"top"===e?{left:a.left+a.width/2-r.width/2,top:a.top-r.height-m}:{left:a.left+a.width/2-r.width/2,top:a.top+a.height+m}}var r=o.offsetRect(u,w),a=o.offsetRect(E,w),i=n(A);A?i=t(i):i.top>w.prop("scrollHeight")-r.height-m&&(i=t(n("top"))),u.css({top:i.top+"px",left:i.left+"px"}),e()}a(u);for(var E=u.parent(),$=angular.element(u[0].getElementsByClassName("md-background")[0]),M=angular.element(u[0].getElementsByClassName("md-content")[0]),A=f.mdDirection;"none"==t.getComputedStyle(E[0])["pointer-events"];)E=E.parent();for(var T=u.parent()[0];T&&T!==i[0]&&T!==document.body&&(!T.tagName||"md-content"!=T.tagName.toLowerCase());)T=T.parentNode;var w=angular.element(T||document.body);angular.isDefined(f.mdDelay)||(l.delay=s),u.detach(),u.attr("role","tooltip"),u.attr("id",f.id||"tooltip_"+o.nextUid()),E.on("focus mouseenter touchstart",function(){h(!0)}),E.on("blur mouseleave touchend touchcancel",function(){r[0].activeElement!==E[0]&&h(!1)}),l.$watch("visible",function(e){e?g():b()});var k=n.throttle(function(){l.visible&&v()});angular.element(t).on("resize",k),l.$on("$destroy",function(){l.visible=!1,u.remove(),angular.element(t).off("resize",k)})}var s=0,m=8;return{restrict:"E",transclude:!0,template:'<div class="md-background"></div><div class="md-content" ng-transclude></div>',scope:{visible:"=?mdVisible",delay:"=?mdDelay"},link:l}}angular.module("material.components.tooltip",["material.core"]).directive("mdTooltip",e),e.$inject=["$timeout","$window","$$rAF","$document","$mdUtil","$mdTheming","$rootElement","$animate","$q"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.8.3.1
 ...
 * v0.8.3.1
 */
function(){"use strict";function e(e,t,n,r){function o(){return v(e.selectedIndex)}function a(){return e.selectedIndex}function i(t,n){h.add(t,n),angular.isDefined(t.element.attr("md-active"))||-1!==e.selectedIndex&&angular.isNumber(e.selectedIndex)&&e.selectedIndex!==g.indexOf(t)?t.onAdd(g.contentArea,!0):(t.onAdd(g.contentArea,!1),g.select(t)),e.$broadcast("$mdTabsChanged")}function c(t,n){if(h.contains(t)&&!n){var r=o()===t,a=f()||u();m(t),h.remove(t),t.onRemove(),e.$broadcast("$mdTabsChanged"),r&&l(a)}}function d(t,n){var r=o()===t;h.remove(t),h.add(t,n),r&&l(t),e.$broadcast("$mdTabsChanged")}function l(t,n){!t||t.isSelected||t.isDisabled()||h.contains(t)&&(angular.isDefined(n)||(n=b(t)<e.selectedIndex),m(o(),n),e.selectedIndex=b(t),t.isSelected=!0,t.onSelect(n),e.$broadcast("$mdTabsChanged"))}function s(e){g.tabToFocus=e}function m(t,n){t&&t.isSelected&&h.contains(t)&&(e.selectedIndex=-1,t.isSelected=!1,t.onDeselect(n))}function u(e,t){return h.next(e||o(),t||p)}function f(e,t){return h.previous(e||o(),t||p)}function p(e){return e&&!e.isDisabled()}var h=n.iterator([],!1),g=this;g.$element=t,g.scope=e;var b=(g.contentArea=angular.element(t[0].querySelector(".md-tabs-content")),g.inRange=h.inRange,g.indexOf=h.indexOf),v=g.itemAt=h.itemAt;g.count=h.count,g.getSelectedItem=o,g.getSelectedIndex=a,g.add=i,g.remove=c,g.move=d,g.select=l,g.focus=s,g.deselect=m,g.next=u,g.previous=f,e.$on("$destroy",function(){m(o());for(var e=h.count()-1;e>=0;e--)c(h[e],!0)})}angular.module("material.components.tabs").controller("$mdTabs",e),e.$inject=["$scope","$element","$mdUtil","$timeout"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.8.3.1
